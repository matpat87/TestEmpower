...
if(!class_exists('ImagegalleryOFLicense')) 
{
    class ImagegalleryOFLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            $validated = ImagegalleryOFLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = ImagegalleryOFLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('ImagegalleryOFLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('ImagegalleryOFLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = ImagegalleryOFLicense::doValidate($currentModule);
