...
{if $SHOWCOPYSTUDIO}
<input title='{$COPYSTUDIO}' accessKey='M' class='button' onclick="if (confirm('{$MOD.LBL_STUDIO_QUICKCRM_CONFIRMATION}')) {ldelim}CopyFromStudio('{$module}','fields','{$profile}'); return true;{rdelim} return false;" type='button' name='button' value='{$COPYSTUDIO}'></input>
{/if}
