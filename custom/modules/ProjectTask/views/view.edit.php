...
class ProjectTaskViewEdit extends ViewEdit {
    ...
    function display()
    {
        ...
        //$this->bean->date_worked_non_db = $time_and_date->customeDateFormatter($time_and_date->new_york_format, "m/d/Y");
        $this->bean->status_update_c = '';
        $time_and_date = new TimeAndDateCustom();
        $this->bean->date_worked_non_db = $time_and_date->customeDateFormatter($time_and_date->new_york_format, "m/d/Y");
    ...
    private function include_css(){
        echo '<link rel="stylesheet" href="custom/modules/ProjectTask/css/custom.css" />';
    }
}
