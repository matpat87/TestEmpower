...
$the_form .= <<<EOQ
	...
	#sortable1 li, #sortable2 li { margin: 0 5px 5px 5px; padding: 5px; font-size: 1.2em; text-align:left ;}
 	#sortable2 li span.ui-icon{display: none;}
 	#sortable1 li span.ui-icon{position: absolute;}
 	#sortable1 li {text-align:center}
	</style>
	<script>
	$(function() {
...
foreach($available_modules as $module){
	$the_form .= "<li id= 'u_{$module['id']}' class='ui-state-default'><span class='ui-icon ui-icon-arrowthick-2-n-s'></span>{$module['full_name']}</li>";
}
$the_form .= <<<EOQ
					</ul>
				</div>
