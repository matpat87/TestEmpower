...
EOJS;
    ...
    public function addParent($displayname, $field)
    {
        ...
        // APX Custom Codes: Changed method to cstm_get_account_array and added shipping_address_street to field_list
        $qsName = array(
            'form' => 'MassUpdate',
            // 'method' => 'query',
        ...
        // APX Custom Codes: Added sqsNoAutofill on input parent_name
        return <<<EOHTML
...
<td>
    ...
    <tr>
        ...
        <td valign='top'>
			...
			<input name='parent_name' id='mass_parent_name' class='sqsEnabled sqsNoAutofill' autocomplete='off'
                type='text' value=''>
...
EOQ;
    ...
    public function addUserName($displayname, $varname, $id_name, $mod_type = null)
    {
        ...
        // APX Custom Codes: Added sqsNoAutofill on input $varname
        return <<<EOHTML
<td width='15%'  scope='row' class='dataLabel'>$displayname</td>
<td width='35%' class='dataField'>
    <input name='{$varname}' id='mass_{$varname}' class='sqsEnabled sqsNoAutofill' autocomplete='off' type='text' value=''>
...
EOHTML;
    ...
    public function addAccountID($displayname, $varname, $id_name = '')
    {
        ...
        // APX Custom Codes: Added sqsNoAutofill on input mass_$varname
        $html = '<td scope="row">' . $displayname . " </td>\n"
            . '<td><input class="sqsEnabled sqsNoAutofill" type="text" autocomplete="off" id="mass_' . $varname . '" name="' . $varname . '" value="" /><input id="mass_' . $id_name . '" type="hidden" name="'
    ...
    public function addAssignedUserID($displayname, $varname)
    {
        ...
        // APX Custom Codes: Added sqsNoAutofill on input mass_assigned_user_name
        $html = <<<EOQ
		<td width="15%" scope="row">$displayname</td>
