...
{/if}
	...
	<tr>
	<td style="width:200px;" id="div_color">&nbsp;{$APP_STRINGS.LBL_THEME_COLOR} : {$LISTVIEW}</td>
	<td>
...
{if $MAPVIEW}
	<tr>
	<td style="width:200px;" id="div_mapcolor">&nbsp;{$MAPVIEW}</td>
	<td>
		<select id="mapcolorfield" name="mapcolorfield">
			{html_options options=$color_options selected=$mapcolor_value}
		</select>
	</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
...
{/if}
	<tr>
	<td style="width:200px;" id="div_color">&nbsp;{$MOD.LBL_BARCODE}</td>
	<td>
		<select id="barcode" name="barcode">
			{html_options options=$barcode_options selected=$barcode_value}
		</select>
	</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
