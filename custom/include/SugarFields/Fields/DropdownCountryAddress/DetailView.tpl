...
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
    <tr>
        <td width='99%'>
            ...
            {{* Ontrack #1906: Commented original version and pasted customised version: removed escape:'html' for billing/shipping  country,street, and city *}}
            {$fields.{{$displayParams.key}}_address_country.value|escape:'htmlentitydecode'|url2html|nl2br}
            <br>
            {$fields.{{$displayParams.key}}_address_street.value|escape:'htmlentitydecode'|url2html|nl2br}
            <br>
            {$fields.{{$displayParams.key}}_address_city.value|escape:'htmlentitydecode'|url2html|nl2br} {$fields.{{$displayParams.key}}_address_state.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}
            &nbsp;&nbsp;{$fields.{{$displayParams.key}}_address_postalcode.value|escape:'htmlentitydecode'|strip_tags|url2html|nl2br}
