...
class CustomSAS_SalesActivityStatisticsViewList extends ViewList
{
    function CustomSAS_SalesActivityStatisticsViewList()
    {
        parent::ViewList();
    }
    ...
    function listViewProcess()
    {
        ...
        if (empty($_REQUEST['search_form_only']) || $_REQUEST['search_form_only'] == false) {
            ...
            $this->lv->setup($this->seed, 'custom/modules/SAS_SalesActivityStatistics/ListView/ListViewGenericReports.tpl', $this->where, $this->params);
