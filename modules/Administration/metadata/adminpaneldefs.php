...
// APX Custom Codes: OnTrack #983 - Add Module Management -- START
$admin_option_defs['Users']['module_management']= [
    'MDM_ModuleManagement',
    'LBL_MODULE_MANAGEMENT',
    'LBL_MANAGE_MODULE',
    './index.php?module=MDM_ModuleManagement&action=index',
    'module-management'
];
// APX Custom Codes: OnTrack #983 - Add Module Management -- END
