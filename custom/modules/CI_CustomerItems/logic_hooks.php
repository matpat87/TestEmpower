...
$hook_array['before_save'][] = Array(3, 'Item Master - Customer Item Quick Create by cloning Item Master details to Customer Item', 'custom/modules/CI_CustomerItems/hooks/beforeSaveHook.php', 'beforeSaveHook', 'itemMasterQuickCreateCustomerItem');
