...
class ContactFormBase extends PersonFormBase
{
    ...
    public function getDuplicateQuery($focus, $prefix='')
    {
        ...
        // $query = 'SELECT contacts.id, contacts.first_name, contacts.last_name, contacts.title FROM contacts ';  //OnTrack #1188 - commented for Sec Group fix

        global $current_user, $log;

        //OnTrack #1188 - Contact Duplicate Checking
        if (! $current_user->is_admin) {
            $query = "select contacts.id,
                    ...
                    where contacts.deleted = 0
                        AND (contacts.assigned_user_id = '{$current_user->id}'
                            OR EXISTS (
                                SELECT  1
            ...
            $query = 'select id, first_name, last_name, title from contacts where contacts.deleted=0 and ';
        }
        ...
        // $query .= ' where contacts.deleted = 0 AND '; // OnTrack #1188 - commented for Sec Group fix
