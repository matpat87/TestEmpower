...
$dashletData['OpportunityUpdatesDashlet']['searchFields'] = array('date_entered'     => array('default' => ''),
...
$dashletData['OpportunityUpdatesDashlet']['columns'] = array('name' => array('width'   => '35', 
                                                                          'label'   => 'LBL_NAME',
                                                                          'link'    => true,
                                                                          'default' => true 
                                                                          ), 
                                                          'account_name' => array('width'  => '35', 
                                                                                  ...
                                                                                  'id' => 'account_id',
                                                                                  'ACLTag' => 'ACCOUNT'),
                                                          'next_step' => array('width'   => '15', 
                                                                                      'label'   => 'LBL_NEXT_STEP', 'default' => true, ),
