...
{* - Updated roles data display to allow scrolling and stick role actions at the top of the scroll area *}
{* - NOTE: This is a core customization and is not upgrade-safe *}
...
{foreach from=$ACTION_NAMES item="ACTION_NAME" }
	<td style="text-align: center; position: sticky; top: 0" scope="row"><b>{$ACTION_NAME}</b></td>
{foreachelse}
...
{foreach from=$CATEGORIES item="TYPES" key="CATEGORY_NAME"}
	...
	{* OnTrack 1577 Fix: added "&& $APP_LIST.moduleList[$CATEGORY_NAME]!=''" in IF block to exclude blank module names that are not yet in the $app_list_strings['moduleList'] *}
