...
<div class="moduleTitle">
    ...
    <h4>Dashboards will be added as new tabs for each user even if previously deployed to a user</h4>
    <h4>Users will need to logout and then back in to see the new dashboards</h4>
</div>
<br/>
