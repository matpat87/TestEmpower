...
<table width="100%"  align="center" class="list view table table-bordered" cellspacing="0" cellpadding="0">
	<thead>
		<tr>
			<th align="center" colspan="4" style="width:25%; ">
				<div style="white-space: normal; width:100%; text-align:center;padding: 0.75rem">
					{$current_salesgroup_name}
				</div>
			</th>
		...
		<tr class="oddListRowS1">
			<td valign="top" class="text-center">
				<div class="row">
					...
					<div class="col-xs-4">
						<span class="dot {$mySalesPerformance.asp_dot_color}"></span>
					</div>
				</div>
			</td>

			<td class="text-center valign-middle">
				<span>${$mySalesPerformance.cmy_actual_asp}<span>
			</td>

			<td class="text-center valign-middle">
				<span>${$mySalesPerformance.cmy_budget_asp}<span>
			</td>

			<td class="text-center valign-middle">
				<span>${$mySalesPerformance.lmy_actual_asp}<span>
			</td>
		</tr>
</table>
</div>
