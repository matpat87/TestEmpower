...
class SugarWidgetSubPanelTopSelectDistributionButton extends SugarWidgetSubPanelTopSelectButton
{
     ...
     */
    function SugarWidgetSubPanelTopSelectDistributionButton($button_properties=array()){
	...
	function display($widget_data, $additionalFormFields = NULL, $nonbutton = false)
	{
		...
		$this->module_name = 'DSBTN_Distribution';
		...
		$link_field_name = 'tr_technicalrequests_dsbtn_distribution_1';
		$popup_mode='Single';
