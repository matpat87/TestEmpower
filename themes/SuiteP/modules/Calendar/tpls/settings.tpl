						...
						<div class="panel panel-default ">
							...
							<div id="subpanel_settings_settings" class="panel-body panel-collapse collapse in">
								...
								<table class='table-responsive'>
									{* APX Custom Codes to allow users to filter Calendar Data by User -- START *}
									<tr>
										<td scope="row" valign="top" width="55%">
											{$MOD.LBL_SETTINGS_USER_FILTER}
										</td>
										<td width="45%">
											<input type="hidden" name="test" value="user filter here">
											<select name="calendar_user_filter_id" style="min-width: 22rem;">
												 {foreach from=$USER_FILTER key=key item=value}
													{if $CALENDAR_USER_FILTER_ID == $key}
									...
									{* APX Custom Codes to allow users to filter Calendar Data by User -- END *}
									<tr>
										<td scope="row" valign="top" width="55%">
