...
EOHTML;
    ...
    if ($includeJS) {
        ...
        // APX Custom Codes: DataTables CSS and JS CDN includes -- Start
        echo '<link rel="stylesheet" type="text/css" href="custom/include/Datatables-2-1-6/dataTables-2-1-6.dataTables.min.css">';
        echo '<script type="text/javascript" src="custom/include/Datatables-2-1-6/dataTables-2-1-6.min.js"></script>';
        // APX Custom Codes: DataTables CSS and JS CDN includes -- End
