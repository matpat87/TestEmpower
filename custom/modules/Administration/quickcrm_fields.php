...
$ss->assign('COPYSTUDIO', $mod_strings['LBL_QCOPY_FROM'] . ' ' . $MBmod_strings['LBL_STUDIO']);

$ss->assign('SHOWCOPYSTUDIO',isset($sugar_config['quickcrm_copystudio']) && $sugar_config['quickcrm_copystudio']);
...
$tools_field = array(array('field' => $MBmod_strings['LBL_NEW_PANEL'], 'label' => $MBmod_strings['LBL_NEW_PANEL']));
