...
class BR_BudgetReport extends Basic
{
    public $new_schema = true;
    public $module_dir = 'BR_BudgetReport';
    public $object_name = 'BR_BudgetReport';
    public $table_name = 'br_budgetreport';
    ...
    {       
        ...
        $customUserList = getUserRepresentativesForReports();
