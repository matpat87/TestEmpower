...
class M2MRelationship extends SugarRelationship
{
    ...
    public function add($lhs, $rhs, $additionalFields = array())
    {
        ...
        $moduleList = ['User', 'ACLRole', 'Account', 'aCase', 'Contact', 'Opportunity', 'TR_TechnicalRequests', 'DSBTN_Distribution',
            'ODR_SalesOrders', 'AOS_Invoices']; //Colormatch #304, #305, #981, #982
