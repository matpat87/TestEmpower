...
class RD_RegulatoryDocuments extends File
{
    public $new_schema = true;
    public $module_dir = 'RD_RegulatoryDocuments';
    public $object_name = 'RD_RegulatoryDocuments';
    public $table_name = 'rd_regulatorydocuments';
