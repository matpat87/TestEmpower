...
class UsersController extends SugarController
{
    ...
    // APX Custom Codes: OnTrack #608 -- START
    protected function action_retrieve_logged_user_division()
    {
        global $current_user;
        echo json_encode($current_user->division_c);
    }
    // APX Custom Codes: OnTrack #608 -- END
}