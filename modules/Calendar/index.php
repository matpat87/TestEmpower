...
global $cal_strings, $current_language, $current_user; // APX Custom Codes: Added $current_user
$calendar_user = BeanFactory::getBean('Users', $current_user->getPreference('calendar_user_filter_id')); // APX Custom Codes
...
if ($cal->view == "sharedMonth" || $cal->view == "sharedWeek") {
    ...
    if (array_key_exists($cal->view, $views)) {
        ...
        $cal->add_activities($calendar_user);
