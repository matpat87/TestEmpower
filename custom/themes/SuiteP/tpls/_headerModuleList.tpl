            ...
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a href="index.php?module=Cases&action=EditView&return_module=Cases&return_action=DetailView">Create Customer Issue</a></li>
                        <li><a href="index.php?module=Calls&action=EditView&return_module=Calls&return_action=DetailView">Log Call</a></li>
                        <li><a href="index.php?module=Meetings&action=EditView&return_module=Meetings&return_action=DetailView">Schedule Meeting</a></li>
                        <li><a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView">Create Note or Attachment</a></li>
            ...
            <!--<div {if $smarty.cookies.sidebartoggle == 'collapsed'}style="display:none"{/if}
             ...
             class="sidebar">
                ...
                <div id="actionMenuSidebar" class="actionMenuSidebar">
                    <ul>
                        <li class="actionmenulinks" role="presentation">
                            <a href="index.php?entryPoint=switchUserEntryPoint&back_to_sudo={$smarty.session.sudo_user_id}" data-action-name="Logout Sudo">
                                <div class="side-bar-action-icon">
