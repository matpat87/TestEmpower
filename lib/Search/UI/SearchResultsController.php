...
class SearchResultsController extends Controller
{
    ...
    public function display(): void
    {
        ...
        /**
         * APX CUSTOM CODES: Assign $app_list_strings to Smarty for rendering the Module Name
         * in the search results instead of the module object name (ex. 'AOS_Invoices' should render Invoices)
        */
        $smarty->assign('APP_LIST_STRINGS', $app_list_strings);
        // End of APX Custom Code
