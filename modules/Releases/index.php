...
if ($is_edit) {
    ...
    // APX Custom Codes to fix UI issues and add custom Application field in ListView -- START
    $xtpl->assign('APPLICATION', $focus->application);
    $xtpl->assign('APPLICATION_OPTIONS', get_select_options_with_id($app_list_strings['application_list'], $focus->application));
    // APX Custom Codes to fix UI issues and add custom Application field in ListView -- END
