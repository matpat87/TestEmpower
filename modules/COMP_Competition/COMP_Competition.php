...
class COMP_Competition extends Company
{
    public $new_schema = true;
    public $module_dir = 'COMP_Competition';
    public $object_name = 'COMP_Competition';
    public $table_name = 'comp_competition';
        ...
        ) 
    {
        ...
        if (! $current_user->is_admin) {
            if ($return_array) {
                $result['where'] .= " AND comp_competition.division = '{$current_user->division_c}'";
            } else {
                $result = str_replace("comp_competition.deleted=0", "comp_competition.deleted=0 AND comp_competition.division = '{$current_user->division_c}'", $result);
            }
        }
