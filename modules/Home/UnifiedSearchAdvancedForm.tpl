...
<input type='hidden' id='showGSDiv' name='showGSDiv' value='{$SHOWGSDIV}'>
	...
	<tr style='padding-bottom: 10px'>
		<td class="submitButtons" colspan='8' nowrap>
			...
			{* APX Custom Codes: Ontrack #1235 - Added display: none for toggleInlineSearch button to disable toggling the enable/disable module setting -- START *}
			<a href="#" onclick="javascript:toggleInlineSearch();" style="display: none; font-size:12px; font-weight:bold; text-decoration:none; text-shadow:0 1px #FFFFFF;">{$MOD.LBL_SELECT_MODULES}&nbsp;
			{* APX Custom Codes: Ontrack #1235 - Added display: none for toggleInlineSearch button to disable toggling the enable/disable module setting -- END *}
            {if $SHOWGSDIV == 'yes'}
