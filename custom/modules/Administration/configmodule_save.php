...
function SaveModuleConfig($module){
	...
	$qutils->mobile['marked'][$module]=$_POST['colorfield'];

	$qutils->mobile['barcodes'][$module]=$_POST['barcode'];
	
	if (in_array ($module,$qutils->getMapModules())){
		if (!isset($qutils->mobile['mapcolor'])) $qutils->mobile['mapcolor'] =array();
		$qutils->mobile['mapcolor'][$module]=$_POST['mapcolorfield'];
	}
