    ...
    array (
      ...
      array (
        ...
        array (
          ...
          4 => 
          array (
            'customCode' => '{if ($fields.account_type.value eq "CustomerParent") || ($fields.account_type.value eq "Customer")}<form action="index.php?entryPoint=AccountProfileReport" method="POST" name="CustomAccountProfileForm" id="form" target="_blank">
                  <input type="hidden" name="account_id" id="account_id" value="{$fields.id.value}">
                  <input type="submit" name="duplicate" id="duplicate" title="Account Profile Report" class="button custom-hide-btn" value="Account Profile Report">
                </form>{/if}',
          ),
        ),
      ),
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          array (
            'name' => 'annual_spend_c',
            'label' => '{$MOD.LBL_ANNUAL_SPEND} ({$CURRENCY})',
          ),
        ),
        5 => 
        array (
