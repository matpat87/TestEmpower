...
<TR>
<td scope="row" align='right'>{$MOD.LBL_DIVISION}:<span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></td><td >
<select id="division" name='division' tabindex='1'>{$DIVISION_OPTIONS}</select>
</td><td>&nbsp;</td><td>&nbsp;</td>
</tr>
...
addToValidate('EditView', 'division', 'enum', true, '{$MOD.LBL_DIVISION}');
</script>
{* APX Custom Codes: OnTrack #607 - Added Division Field -- END *}