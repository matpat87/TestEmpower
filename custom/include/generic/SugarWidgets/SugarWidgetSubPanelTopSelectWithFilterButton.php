...
class SugarWidgetSubPanelTopSelectWithFilterButton extends SugarWidgetSubPanelTopButton
{
    ...
    public function display($widget_data, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        // APX Custom Code: Add ability to pass initial filter in Popup Search when triggered via SELECT from Subpanel -- START
        /*
        ...
        // APX Custom Code: Add ability to pass initial filter in Popup Search when triggered via SELECT from Subpanel -- END
        $create="true";
