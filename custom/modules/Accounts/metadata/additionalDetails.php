...
function additionalDetailsAccount($fields) {
    ...
    $overlib_string .= '<b>'. $mod_strings['LBL_USERS_ACCOUNTS_1_FROM_USERS_TITLE'] . '</b><br>';
    if (!empty($fields['USERS_ACCOUNTS_1_NAME'])) $overlib_string .= '<span class="">' . $fields['USERS_ACCOUNTS_1_NAME'] . '</span><br>';
    
    $overlib_string .= '<b>'. $mod_strings['LBL_USERS_ACCOUNTS_2_FROM_USERS_TITLE'] . '</b><br>';
    if (!empty($fields['USERS_ACCOUNTS_2_NAME'])) $overlib_string .= '<span class="">' . $fields['USERS_ACCOUNTS_2_NAME'] . '</span><br>';

    //    $GLOBALS['log']->fatal(json_encode($mod_strings));
