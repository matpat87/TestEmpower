...
<table border='0' cellpadding='0' cellspacing='0' width='100%'>
    <tr>
        <td width='99%'>
            ...
            <input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_street2_c"
                   value="{$fields.{{$displayParams.key}}_address_street.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
            ...
            <br>
            {$fields.{{$displayParams.key}}_address_street2_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}
            <br>
