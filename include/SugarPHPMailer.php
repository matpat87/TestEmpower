...
eoq;
    ...
    public function handleAttachments($notes)
    {
        ...
        $this->replaceImageByRegex(
            ...
            $sugar_config['upload_dir'], // APX Custom Codes: Ontrack #1833 - Document storage configuration options
            true
        );
        ...
        foreach ($notes as $note) {
            ...
            if ($note->object_name === 'Note') {
                ...
                $filename = $note->id . $note->filename;
                $file_location = "{$sugar_config['upload_dir']}{$filename}"; // APX Custom Codes: Ontrack #1833 - Document storage configuration options
                $mime_type = $note->file_mime_type;
            }
