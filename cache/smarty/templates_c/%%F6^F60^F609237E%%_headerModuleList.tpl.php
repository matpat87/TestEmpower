...
"></span>
                ...
                -->
                <?php if (! empty ( $_SESSION['sudo_user_id'] )): ?>
                <div id="actionMenuSidebar" class="actionMenuSidebar">
                    <ul>
                        <li class="actionmenulinks" role="presentation">
                            <a href="index.php?entryPoint=switchUserEntryPoint&back_to_sudo=<?php echo $_SESSION['sudo_user_id']; ?>
" data-action-name="Logout Sudo">
                                <div class="side-bar-action-icon">
