...
class ListViewSmarty extends ListViewDisplay
{
    ...
    public function display($end = true)
    {
        ...
        global $app_strings, $sugar_version, $sugar_flavor, $currentModule, $app_list_strings, $sugar_config;
        ...
        // APX Custom Code: assign a variable to enable custom pagination in list view
        $this->ss->assign('customPagination', $sugar_config['enable_custom_pagination'] ?? false);
