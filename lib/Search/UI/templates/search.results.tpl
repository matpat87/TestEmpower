...
{else}
    ...
    {* APX Custom Codes: Fixed issue where module name displayed is not converted to label display (Ex. AOS_Invoices is displayed instead of Invoices) -- START *}
    {* <h3>{$module}</h3> *}
    <h3>{$APP_LIST_STRINGS.moduleList.$module}</h3>
    {* APX Custom Codes: Fixed issue where module name displayed is not converted to label display (Ex. AOS_Invoices is displayed instead of Invoices) -- END *}
    {* APX Custom Codes: <table> element added custom class name apx-global-search-cstm-class -- START   *}
    <table class="list view apx-global-search-cstm-class">
    {* APX Custom Codes: <table> element added custom class name apx-global-search-cstm-class -- END   *}
        <thead>
            <tr>
                <th></th>
