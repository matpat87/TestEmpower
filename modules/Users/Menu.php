...
// APX Custom Codes to allow Admin to Sudo Login as any user -- START
if ($current_user->is_admin &&
     ...
     $module_menu[] = Array("index.php?entryPoint=switchUserEntryPoint&user_id=" . $_REQUEST['record'], "Login As {$userName}", "");
}
// APX Custom Codes to allow Admin to Sudo Login as any user -- END
