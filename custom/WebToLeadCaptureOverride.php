...
if (isset($_POST['campaign_id']) && !empty($_POST['campaign_id'])) {
	    ...
	    if(isset($camp_data) && $camp_data != null ){
			...
			// If Honeypot field is populated, unset $lead to prevent record from being generated in the system
			if (isset($_POST['alt_email_address']) && $_POST['alt_email_address']) {
				unset($lead);
			}
