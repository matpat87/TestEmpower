...
class SugarWidgetSubpanelContactsCreateButton extends SugarWidgetSubPanelTopButton
{
    ...
    function display($defines, $additionalFormFields = null)
    {
		...
		$button .= '<form><a href="index.php?module=Contacts&action=EditView&account_name='. $name .'&account_id='. $id .'&return_module=Accounts&return_id='. $id .'&return_action=DetailView&;">Create</a></form>';
