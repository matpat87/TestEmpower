...
EOD;
    ...
    protected function constructQuery()
    {
        ...
        $query = "SELECT lead_source,sales_stage,sum(amount/1000) as total, count(*) as opp_count 
            FROM (
        ...
        $query .= " AND securitygroups_users.user_id = '{$current_user->id}' GROUP BY opportunities.id
            ) AS chartData
            GROUP BY sales_stage,lead_source ORDER BY lead_source,sales_stage";
