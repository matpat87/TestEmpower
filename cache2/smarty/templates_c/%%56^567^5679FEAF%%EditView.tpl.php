<?php /* Smarty version 2.6.29, created on 2018-06-14 04:44:41
...
<script type="text/javascript" src='include/SugarFields/Fields/Image/SugarFieldFile.js?v=1GLWaVId2psFdAh3QsKJyA'></script>
...
<?php echo '\' );
addToValidate(\'EditView\', \'businessunit_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_BUSINESSUNIT','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'division_c\', \'enum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DIVISION','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'erpuserid_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ERPUSERID_C','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'erp_uid_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ERP_UID','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'legacy_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_LEGACY','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'marital_status_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MARITAL_STATUS','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'salesregion_c[]\', \'multienum\', true,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALESREGION','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'sites_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SITES','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'erp_id_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ERP_ID','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'EditView\', \'sales_grp_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SALES_GRP','module' => 'Users','for_js' => true), $this);?>
<?php echo '\' );
