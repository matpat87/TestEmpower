...
<html lang="<?php echo $sugar_config['default_language']; ?>">
	...
	<body>
		...
		<?php 
			// FORCE_EXECUTE_EVENT
			if ($focus->trigger_type == 'scheduled') {
				$LBL_FORCE_EXECUTE_EVENT_BUTTON = translate('LBL_FORCE_EXECUTE_EVENT_BUTTON','asol_Events');
	
				$forceExecuteEvent = "<img src='modules/asol_Process/___common_WFM/images/force_execute_event.png' onClick='forceExecuteEvent(\"{$focus->id}\");' title='{$LBL_FORCE_EXECUTE_EVENT_BUTTON}' style='cursor: pointer;' />";
				echo "{$forceExecuteEvent}<br><br>";
			}
		?>
										...
										<table width="100%" border="0" cellspacing="1" cellpadding="0"  id='LBL_ASOL_TRIGGERING_PANEL'  class="yui3-skin-sam edit view panelContainer">
											...
											<tr>
												...
												<td id="form_cell" width="10%" valign="top">
													<?php require_once("modules/asol_Events/customFields/form.php"); ?>
												</td>
												...
												<?php 
													if (wfm_reports_utils::hasPremiumFeatures()) {
														require_once('modules/asol_Process/___common_WFM_premium/modules/asol_Events/customFields/html_for_field_audit.enterprise.php');
													} else {
														require_once('modules/asol_Events/customFields/html_for_field_audit.community.php');
													}
												?>
