...
class registry_quickcrm extends registry_v4_1 {
   ...
   //Add get_relationships with "pagination" support
	   ...
	   $this->serviceClass->registerFunction(
		...
		$this->serviceClass->registerFunction(
		    'get_chart',
		    array('session'=>'xsd:string', 'id'=>'xsd:string', 'chart_id'=>'xsd:string', 'width'=>'xsd:string', 'height'=>'xsd:string', 'lang'=>'xsd:string','withRGraph'=>'xsd:int'),
		    array('return'=>'tns:get_entry_result_version2'));
		...
		$this->serviceClass->registerFunction(
		    'Emailsset_entry',
		    array('session'=>'xsd:string', 'module_name'=>'xsd:string',  'name_value_list'=>'tns:name_value_list','track_view'=>'xsd:int', ),
		    array('return'=>'tns:new_set_entry_result'));
        ...
        $this->serviceClass->registerFunction(
            'getDeletedRecords', 
            array('session' => 'xsd:string', 'module_name' => 'xsd:string', 'start_date' => 'xsd:string', 'end_date' => 'xsd:string'), 
            array('return' => 'xsd:string'));
        $this->serviceClass->registerFunction(
            'SAMLLogin', 
            array('token' => 'xsd:string', 'language' => 'xsd:string'), 
