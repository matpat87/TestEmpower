...
$hook_array['after_save'][] = Array(1, 'Handle Work Group Reassignment', 'custom/modules/SecurityGroups/hooks/SecurityGroupsAfterSaveHook.php', 'SecurityGroupsAfterSaveHook', 'handleWorkGroupReassignment');
