...
{ 
	...
	public function __construct($id, $def = null) 
	{
        ...
        while($row = $db->fetchByAssoc($result)) {
            ...
            $this->myTopTenAccounts[$ctr]['last_activity_date_c'] = $row['last_activity_date_c'];
    ...
    {	
        ...
        $ss->assign('lblLastActivityDate', str_replace(':', '', translate('LBL_LAST_ACTIVITY_DATE', 'Accounts')));    
        ...
        $ss->assign('lblShippingState', str_replace(':', '', translate('LBL_SHIPPING_ADDRESS_STATE', 'Accounts')));    
