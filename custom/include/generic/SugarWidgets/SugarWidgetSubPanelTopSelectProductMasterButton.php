...
class SugarWidgetSubPanelTopSelectProductMasterButton extends SugarWidgetSubPanelTopButton
{
     ...
     */
    function SugarWidgetSubPanelTopSelectProductMasterButton($button_properties=array()){
	...
	function display($widget_data, $additionalFormFields = NULL, $nonbutton = false)
	{
		...
		// Note: set_return_and_save_background_and_hide_button is set on TR detail.js
		$popup_request_data = array(
			'call_back_function' => 'set_return_and_save_background_and_hide_button',
