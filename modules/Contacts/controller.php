...
class ContactsController extends SugarController
{
    ...
    public function action_get_account_address()
    {
      global $log;
      ...
      $returnArray['billing_address_country'] = $accountBean->billing_address_country;
      $returnArray['billing_address_street'] = $accountBean->billing_address_street;
      $returnArray['billing_address_city'] = $accountBean->billing_address_city;
      $returnArray['billing_address_state'] = $accountBean->billing_address_state;
      $returnArray['billing_address_postalcode'] = $accountBean->billing_address_postalcode;
