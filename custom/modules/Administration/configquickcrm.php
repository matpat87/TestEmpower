...
<script type="text/javascript" src="custom/modules/Administration/conf_quickcrm.js?v=6.5.4"></script>
<style>
    .myOverlayClass  {
    ...
    .ui-state-highlight.label_sortable, .ui-state-default.label_initial{
        background: #bfcad3;
    }
    .ui-state-default.label_initial{
        color: black;
		height: auto !important;
    }
</style>
...
<script type="application/javascript">
    ...
    function check_condition(module,type,profile,profile_name,changebyrefresing){
        ...
        if(copiedFromStudio || $('#conf_sortableD1 li').hasClass('ui-state-default') || $('#conf_sortableD2 li').hasClass('ui-state-highlight') || def!=def2){
