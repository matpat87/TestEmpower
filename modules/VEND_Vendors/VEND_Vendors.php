...
class VEND_Vendors extends Company
{
    public $new_schema = true;
    public $module_dir = 'VEND_Vendors';
    public $object_name = 'VEND_Vendors';
    public $table_name = 'vend_vendors';
    ...
    function create_export_query($order_by, $where, $relate_link_join='')
    {
        ...
        $result = parent::create_export_query($order_by, $where, $relate_link_join);

        //OnTrack #1309 - remove invalid query
        if(strpos($result, '() AND') !== false){
