...
$sugar_smarty->assign('sugar_md',getWebPath('custom/themes/default/images/company_logo.png'));
$sugar_smarty->assign('OLD_PASSWORD_FIELD','<td scope="row" width="10%">'.$mod_strings['LBL_OLD_PASSWORD'].':</td><td width="90%"><div class="col-md-4"><input type="password" size="26" tabindex="1" id="old_password" name="old_password"  value="" class="form-control" /></div></td>');
...
$sugar_smarty->assign(
    'SUBMIT_BUTTON',
    '<input title="'.$app_strings['LBL_SAVE_BUTTON_TITLE'].'" class="button btn-submit" ' // APX Custom Codes: OnTrack #644 - Force Password Change - Added btn-submit class
