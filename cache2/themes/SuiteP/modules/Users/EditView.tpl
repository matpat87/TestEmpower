...
addToValidate('EditView', 'businessunit_c', 'enum', true,'{/literal}{sugar_translate label='LBL_BUSINESSUNIT' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'division_c', 'enum', true,'{/literal}{sugar_translate label='LBL_DIVISION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'erpuserid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ERPUSERID_C' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'erp_uid_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ERP_UID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'legacy_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_LEGACY' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'marital_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MARITAL_STATUS' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'salesregion_c[]', 'multienum', true,'{/literal}{sugar_translate label='LBL_SALESREGION' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'sites_c', 'enum', false,'{/literal}{sugar_translate label='LBL_SITES' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'erp_id_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ERP_ID' module='Users' for_js=true}{literal}' );
addToValidate('EditView', 'sales_grp_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SALES_GRP' module='Users' for_js=true}{literal}' );
