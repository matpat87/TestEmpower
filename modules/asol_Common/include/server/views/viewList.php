...
$html = '<h3>'.translate('LBL_ASOL_COMMON_TITLE', 'asol_Common').'</h3><span>'.translate('LBL_ASOL_ADMIN_PANEL_DESC', 'asol_Common').'</span><table style="margin-top:5px" class="other view">';
