<?php
	...
	while( $row = $db->fetchByAssoc($result)){ 
		...
		$trHTML .= '
		<tr style="">
			<td style="width: 8.33%">'. $row['user_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['leads_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['accounts_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['contacts_non_db'] .'</td>
			...
			<td style="width: 8.33%">'.  $row['notes_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['calls_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['meetings_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['tasks_non_db'] .'</td>
			<td style="width: 8.33%">'.  $row['emails_non_db'] .'</td>
		</tr>';
	}
...
$html = '<table cellpadding="6" style="width: 100%">
	<thead>
		<tr>
			<th style="font-weight: bold; width: 8.33%">User</th>
			<th style="font-weight: bold; width: 8.33%">Leads</th>
			<th style="font-weight: bold; width: 8.33%">Accounts</th>
			<th style="font-weight: bold; width: 8.33%">Contacts</th>
			...
			<th style="font-weight: bold; width: 8.33%">Notes</th>
			<th style="font-weight: bold; width: 8.33%">Calls</th>
			<th style="font-weight: bold; width: 8.33%">Meetings</th>
			<th style="font-weight: bold; width: 8.33%">Tasks</th>
			<th style="font-weight: bold; width: 8.33%">Emails</th>
		</tr>
	</thead>
	<tbody>
		'. $trHTML .'
