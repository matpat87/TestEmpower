...
(function() {
	...
	var _initialised = false, listDiv = document.getElementById("list"),
	...
	}, connections = [], updateConnections = function(conn, remove) {
		if (!remove)
	...
	jsPlumb.ready(function() {
		...
		instance.doWhileSuspended(function() {
			...
			var anchors = [ [ 1, 0.2, 1, 0 ], [ 0.8, 1, 0, 1 ], [ 0, 0.8, -1, 0 ], [ 0.2, 0, 0, -1 ] ], maxConnectionsCallback = function(info) {
				alert("Cannot drop connection " + info.connection.id + " : maxConnections has been reached on Endpoint " + info.endpoint.id);
			};
