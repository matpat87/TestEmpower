                ...
                <tr>
                    <td width='40%'>
                        ...
                        <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                            ...
                            <tr>
                                <td width='35%' scope="row" snowrap>
                                    {$MOD.LBL_IS_RESET_PASSWORD}
                                </td>
                                <td class='dataField'>
                                    <input type="checkbox" id="is_reset_password_c" name="is_reset_password_c" value="1" title="" tabindex="0"
                                        {if $fields.is_reset_password_c.value}
                                            checked
                                        {/if}
                                     />
                                </td>
