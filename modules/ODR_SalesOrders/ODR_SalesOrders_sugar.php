...
class ODR_SalesOrders_sugar extends Basic
{
    public $new_schema = true;
    public $module_dir = 'ODR_SalesOrders';
    public $object_name = 'ODR_SalesOrders';
    public $table_name = 'odr_salesorders';
    ...
    public $shipping_amount_usdollar;
    public $shipping_tax;
    public $shipping_tax_amt;
    public $shipping_tax_amt_usdollar;
    public $status;
    public $subtotal_amount;
    public $subtotal_amount_usdollar;
    public $subtotal_tax_amount;
    public $subtotal_tax_amount_usdollar;
    public $tax_amount;
    public $tax_amount_usdollar;
    public $template_ddown_c;
    public $total_amount;
    public $total_amount_usdollar;
    public $total_amt;
    public $total_amt_usdollar;
     ...
     */
    function ODR_SalesOrders_sugar(){
