...
{if $AUTHENTICATED}
    <div id="ajaxHeader">
        {* APX Custom Codes: If custom _headerModuleList.tpl exists, use it instead of core file -- START *}
        ...
        {/if}
        {* APX Custom Codes: If custom _headerModuleList.tpl exists, use it instead of core file -- END *}
    </div>
{/if}
{literal}
