 ...
 */
require_once('custom/modules/Users/BrowserCheck.php'); // APX Custom Codes: OnTrack #1037 - IE Unsupported
...
if (isset($_SESSION['authenticated_user_id'])) {
    // APX Custom Codes: OnTrack #1037 - IE Unsupported -- START
    $browserCheck = new BrowserCheck();
    $browserCheck->check($authController);
    // APX Custom Codes: OnTrack #1037 - IE Unsupported -- END
