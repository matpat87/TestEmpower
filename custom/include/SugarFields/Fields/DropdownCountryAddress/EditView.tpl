...
{{assign var="id" value=$displayParams.id|upper}}
...
<fieldset id='{{$key}}_address_fieldset' style="margin-top: 0px;"> 
    {{if isset($displayParams.is_hide_title) && $displayParams.is_hide_title == true }}
    ...
    <table border="0" cellspacing="1" cellpadding="0" class="edit" width="100%">
        <tr>
            <td valign="top" id="{{$country}}_label" width='{{$def.templateMeta.widths[$smarty.foreach.colIteration.index].label}}%'
                scope='row'>
        ...
        <tr>
            <td valign="top" id="{{$state}}_label" width='{{$def.templateMeta.widths[$smarty.foreach.colIteration.index].label}}%'
                scope='row'>
        ...
        <tr>
            ...
            <td>
                <input id="{{$displayParams.key}}_checkbox" name="{{$displayParams.key}}_checkbox" type="checkbox"
                       onclick="{{$displayParams.key}}_address.syncFields();" style="margin-top: 11px">
            </td>
        </tr>
        {{else}}
        <tr>
