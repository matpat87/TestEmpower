...
$openSalesStageKeys = array_keys($app_list_strings['open_sales_stage_dom']); // APX Custom Codes: Filter via Open Sales Stages only

$dashletData['MyOpportunitiesDashlet']['searchFields'] = array('date_entered'     => array('default' => ''),
                                                               'opportunity_type' => array('default' => ''),
                                                               'open_sales_stages_non_db' => array('default' => $openSalesStageKeys), // APX Custom Codes: Filter via Open Sales Stages only
