...
require_once('modules/'.$currentModule.'/license/ImagegalleryOFLicense.php');

if($_REQUEST['method'] == 'validate') {
    ImagegalleryOFLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    ImagegalleryOFLicense::change();
} else if($_REQUEST['method'] == 'add') {
    ImagegalleryOFLicense::add();
    ...
    $validate_license = ImagegalleryOFLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = ImagegalleryOFLicense::doValidate($currentModule);
