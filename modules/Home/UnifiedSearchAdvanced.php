...
class UnifiedSearchAdvanced
{
    ...
    public function getDropDownDiv($tpl = 'modules/Home/UnifiedSearchAdvanced.tpl')
    {
        ...
        $users_modules = array(); // Ontrack #1235 fix: force empty array to always load module list as set via Global settings
        ...
        // APX Custom Codes -- START
        // $sugar_smarty->assign('SHOWGSDIV', $showDiv); -- original code
        $sugar_smarty->assign('SHOWGSDIV', 'no'); // Ontrack #1235 fix: hid enable/disable module to force search modules as selected/set in Global Search settings 
        // APX Custom Codes -- END
