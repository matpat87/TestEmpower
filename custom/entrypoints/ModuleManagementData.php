<?php
    ...
    /**
     * usage: http://localhost:8888/empower/index.php?entryPoint=ModuleManagementData
     * **/
    ...
    class ModuleManagementData{
        ...
        */
        ...
        public function process(){
            ...
            $log->fatal('NOT AN ERROR - ModuleManagementData.process: Start');
            ...
            if(!empty($module_list)){
                ...
                echo 'Processing Module Management Data: Start <br/>';
                foreach($module_list as $module){
                    if(!in_array($module, $arr_exempted)){
                        if(!$this->is_module_exist($module)){
                            ...
                            echo 'module' . ': ' . $module . ' record in Module Management has been created. <br/>';
                        }
                    }
                }
                echo 'Processing Module Management Data: End <br/><br/><br/>';

                echo 'Processing ACL Access: Start <br/>';
                    ...
                    if(!in_array($module, $arr_exempted)){
                        foreach($default_acl_actions as $default_acl_action_arr){
                            ...
                            if(!$this->is_acl_acess_exist($default_acl_action_arr)){
                                echo 'module' . ': ' . $module . ' with access: '. $default_acl_action_arr['name'] .' does not exist <br/>';
                                ...
                                echo 'module' . ': ' . $module . ' with access: '. $default_acl_action_arr['name'] .' record has been created <br/>';
                            }
                        }
                    }
                }
                echo 'Processing ACL Access: End <br/><br/><br/>';
            }

            

            $log->fatal('NOT AN ERROR - ModuleManagementData.process: End');
        }
