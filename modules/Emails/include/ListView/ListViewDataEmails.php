...
class ListViewDataEmails extends ListViewData
{
    ...
    protected function getSearchType($folder)
    {
        switch ($folder->getType()) {
            ...
            case "draft":
            case "inbound": // APX Custom Codes: For Displaying Emails on ListView without User Mail Settings
                $this->searchType = "crm";
                break;
    ...
    public function getListViewData(
        ...
        try {
            ...
            // APX Custom Codes: For Displaying Emails on ListView without User Mail Settings -- START
            ...
            //     return false;
            // }
            // APX Custom Codes: For Displaying Emails on ListView without User Mail Settings -- END
