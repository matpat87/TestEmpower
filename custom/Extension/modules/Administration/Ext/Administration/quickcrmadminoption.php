...
//if (isset($sugar_config['quickcrm_homepages']) && $sugar_config['quickcrm_homepages']){
	$admin_option_defs['Administration']['quickcrm_homepages']= array('Studio','LBL_HOMEPAGE_QUICKCRM_TITLE','LBL_HOMEPAGE_QUICKCRM','./index.php?module=QCRM_Homepage&action=index',$suitecrm_710?'studio':null);
//}
...
$admin_option_defs['Administration']['quickcrm_doc']= array('help','LBL_DOC_QUICKCRM_TITLE','LBL_DOC_QUICKCRM','https://www.quickcrm.fr/doc/mobile/latest/QuickCRM_Manual_english.htm?v=6.5.4');
$admin_option_defs['Administration']['quickcrm_devguide']= array('help','LBL_DEVGUIDE_QUICKCRM_TITLE','LBL_DEVGUIDE_QUICKCRM','https://www.quickcrm.fr/doc/mobile/latest/QuickCRM_Developers_Guide.pdf?v=6.5.4');
